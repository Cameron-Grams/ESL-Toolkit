...
const InstructionsModal = ( props ) => {
    const thirdPara = "There is a <span className={ \"errorMessage\" } >known problem </span> with some copying and" +
    " pasting text for the Sentence Scramble exercise; some text from the web has apostophes that break the sentences." +
